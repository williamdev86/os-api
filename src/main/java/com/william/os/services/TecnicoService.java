...
import com.william.os.services.exceptions.DataIntegratyViolationException;
...
public class TecnicoService {
   ...
   public void delete(Integer id) {
		...
		if(obj.getList().size() > 0) {
			throw new DataIntegratyViolationException("Técnico possui Ordens de Serviço ativa, não pode ser deletado!");
		}
